...
export const faqs = [
  {
    question: "What is The Yarn Bazaar?",
    answer:
      "The Yarn Bazaar is a digital marketplace designed to streamline yarn trading by connecting buyers and sellers with ease, transparency, and efficiency.",
  },
  {
