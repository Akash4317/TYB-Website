...
import productImage from '@/images/productss.jpg'
...
const ProductNew = () => {
  return (
      <div className='w-full bg-[#FFCFC242] py-4'>
          <div className='max-w-[95%] h-full p-4 md:p-8 lg:p-12 flex flex-col md:flex-row justify-between '>
              <div>
              ...
              <div className='bg-[#FFAB1A] relative'>
                  <Image
                      src={productImage}
                      alt={'Product Image'}
                      width={0}
