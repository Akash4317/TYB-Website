    ...
    return (
        <div
            ...
            className={cn(
                ...
                currentSlideIndex === (props as any)["data-index"]
                    ? "opacity-100"
                    : "opacity-100",
                className
            )}
            data-index={(props as any)["data-index"]}
            {...props}
        />
    );
});
    ...
    return (
        <Button
            ...
            className={cn(
                ...
                orientation === "horizontal"
                    ? " left-2 md:left-[20%] -bottom-12 -translate-y-1/2"
    ...
    return (
        <Button
            ...
            className={cn(
                ...
                orientation === "horizontal"
                    ? " right-2 md:right-[20%] -bottom-12 -translate-y-1/2"
                ...
                {Array.from({ length: numberOfSlides }, (_, i) => (
                    <Button
                        ...
                        className={`mx-1  h-1.5 w-1.5 rounded-full p-0 ${i === currentSlide
                                ? "scale-125 transform duration-300 transition-all w-8 bg-gray-800 hover:bg-gray-950"
