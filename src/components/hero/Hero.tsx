...
import EfficiencyImage3 from "@/images/EfficiencyImage.svg";
import InnovationImage from "@/images/InnovationImage.svg";
import SustainabilityImage4 from "@/images/SustainabilityImage.svg";
import TrustImage2 from "@/images/TrustImage.svg";


const texts = ["Innovation.", "Trust.", "Efficiency.", "Sustainability."];
const images = [EfficiencyImage3, TrustImage2, InnovationImage,  SustainabilityImage4];
  ...
  return (
    <div className="relative w-full max-w-[95%] mx-auto">
      ...
      <Image
        src={markimage}
        alt="markedImage"
        className="absolute top-0 -left-10 hidden md:block w-auto h-auto"
        width={250}
        height={250}
      />

      <div className="flex flex-col md:flex-row items-center p-4 md:p-8 mt-4 gap-6 md:gap-12 w-full">

        <div className="w-full md:w-1/2 text-center md:text-left">
          <p className="max-w-[727px] font-inter text-[36px] md:text-[70px] font-extrabold leading-[1.2] md:leading-[91px]">
