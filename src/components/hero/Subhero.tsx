...
const Subhero = () => {
    return (
        <div className='flex flex-col md:flex-row items-center p-4 md:p-6 md:mt-4 gap-6 md:gap-12 w-full max-w-[95%] mx-auto relative'>
            ...
            <div className='flex flex-col items-center md:items-start w-full md:w-1/2 text-center md:text-left'>
                ...
                <div className="w-full flex justify-center md:justify-start">
                    <Button
                        variant='default'
                        size='lg'
                        className='mt-2 w-[187px] text-md font-poppins bg-[#F89E24] font-[600] rounded-[15px]'
